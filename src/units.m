...
dimensionNames = {'m','kg','s','coul','K','decay'};  %  Add any dimension you want, (e.g. 'dollar')
...
u.Sv = 1*u.Gy;
u.mSv = 1*u.mGy;
u.coul2Jair = 33.97*u.J/u.coul;  % ion pair creation: takes 33.97 J to make 1 C
